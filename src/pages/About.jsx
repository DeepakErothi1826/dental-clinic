...
const About = () => {
  ...
  const values = [
    { title: 'Patient-Centric', desc: 'Every decision we make puts patient comfort first' },
    { title: 'Excellence', desc: 'We pursue the highest standards in everything we do' },
    { title: 'Integrity', desc: 'Honest, transparent treatment recommendations always' },
    { title: 'Innovation', desc: 'Continuously upgrading our technology and techniques' }
  ];
    ...
    <div className="about-page-wrapper">
      <section className="about-hero" style={{ padding: '8rem 0', position: 'relative', overflow: 'hidden', background: 'var(--primary-blue)' }}>
        <div style={{ position: 'absolute', inset: 0, opacity: 0.2 }}>
            <img src="https://images.unsplash.com/photo-1606811971618-4486d14f3f99?auto=format&fit=crop&q=80&w=1600" alt="Clinic Overlay" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
            ...
            <div className="about-visual">
              <div style={{ position: 'relative' }}>
                <img 
                  ...
                  style={{ width: '100%', borderRadius: '2rem', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}
                />
      ...
      <section className="about-values bg-light-blue" style={{ padding: '6rem 0' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem', marginTop: '3rem' }}>
            {values.map((v, i) => (
              <div key={i} style={{ padding: '2rem', background: 'white', borderRadius: '1rem', textAlign: 'center', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '2rem' }}>
            <div style={{ borderRadius: '2rem', overflow: 'hidden', height: '500px' }}>
              <img src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=1200" alt="Main Clinic" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
              <div style={{ borderRadius: '2rem', overflow: 'hidden', height: '240px' }}>
                <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=600" alt="Sterilization Lab" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
              <div style={{ borderRadius: '2rem', overflow: 'hidden', height: '240px' }}>
                <img src="https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&q=80&w=600" alt="Diagnostic Suite" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            </div>
          </div>
        </div>
